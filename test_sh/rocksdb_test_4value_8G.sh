...
bench_benchmarks="fillrandom,stats,readseq,stats,readrandom,stats"
#bench_benchmarks="fillseq,stats"
#bench_benchmarks="fillrandom,stats,clean_cache,stats,readseq,clean_cache,stats,readrandom,stats"
bench_num="2000000"
